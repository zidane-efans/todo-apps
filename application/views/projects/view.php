<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <a href="<?= site_url('projects') ?>" class="text-muted text-decoration-none mb-2 d-inline-block"><i class="fa-solid fa-arrow-left me-1"></i> Back to Projects</a>
        <h2 class="mb-1 text-dark fw-bold"><?= htmlspecialchars($project->name) ?></h2>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm glass">
            <div class="card-body">
                ...
                <h5 class="fw-bold mb-0"><?= date('M d, Y', strtotime($project->start_date)) ?></h5>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm glass">
            <div class="card-body">
                ...
                <h5 class="fw-bold mb-0"><?= date('M d, Y', strtotime($project->end_date)) ?></h5>
            </div>
        </div>
    </div>
    <div class="col-md-3">
...
<h4 class="fw-bold mb-3">Project Tasks</h4>
<div class="card border-0 shadow-sm glass mb-5">
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0 align-middle">
                ...
                <tbody>
                    <?php if(empty($tasks)): ?>
                    <tr>
                        <td colspan="5" class="text-center py-4 text-muted">No tasks found for this project. Create one!</td>
                    </tr>
